  ...
  return (
    <div className="space-y-6 animate-reveal max-w-3xl">
      ...
      <form onSubmit={handleSubmit} className="p-8 bg-white dark:bg-zinc-900 border border-[#e5e5e5] dark:border-zinc-800 rounded-2xl shadow-xs space-y-6">
        ...
        <div className="border-t border-[#e5e5e5] dark:border-zinc-800 pt-6 space-y-6">
          
          {/* Sección 1: Apariencia Visual */}
          <div className="space-y-4">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-[#666666] dark:text-neutral-400 flex items-center gap-2">
              <Palette size={14} />
              Apariencia Visual
            </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold uppercase tracking-wider text-[#666666] dark:text-neutral-400">Color Primario del Catálogo</label>
              ...
              {/* Nombre de la Marca */}
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-semibold uppercase tracking-wider text-[#666666] dark:text-neutral-400">Nombre de la Marca *</label>
                <input
                  type="text"
                  required
                  value={nombre}
              ...
              {logoUrl ? (
                <div className="flex items-center gap-4 p-4 bg-[#fafafa] dark:bg-zinc-950 border border-[#e5e5e5] dark:border-zinc-800 rounded-2xl max-w-md">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-neutral-400 dark:text-neutral-500 mt-0.5">Imagen de marca de tu vitrina digital</p>
                  </div>
                  <button 
                    type="button"
                    onClick={handleRemoveLogo}
                    className="p-2 text-neutral-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950/20 rounded-xl transition-all"
                ...
                <label className="flex flex-col items-center justify-center border border-dashed border-[#e5e5e5] dark:border-zinc-800 hover:border-zinc-400 dark:hover:border-zinc-700 bg-[#fafafa] dark:bg-zinc-950 hover:bg-[#fafafa]/50 dark:hover:bg-zinc-900/50 rounded-2xl p-6 cursor-pointer group transition-all max-w-md h-32">
                  {loadingLogo ? (
                    <Loader2 className="animate-spin text-zinc-500 mb-2" size={24} />
                  ) : (
                    <UploadCloud className="text-zinc-400 group-hover:text-zinc-600 dark:group-hover:text-neutral-200 mb-1.5 transition-colors" size={24} />
                  )}
                  <span className="text-xs font-semibold text-zinc-600 dark:text-neutral-400 group-hover:text-zinc-800 dark:group-hover:text-neutral-300">
          ...
          <div className="space-y-4 pt-2 border-t border-[#e5e5e5] dark:border-zinc-800">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-[#666666] dark:text-neutral-400 flex items-center gap-2">
              <Phone size={14} />
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-xs font-semibold uppercase tracking-wider text-[#666666] dark:text-neutral-400">Número de WhatsApp (con código de país)</label>
              <input
                type="tel"

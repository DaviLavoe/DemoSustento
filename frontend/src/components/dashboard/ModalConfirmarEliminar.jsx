...
export default function ModalConfirmarEliminar({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl border border-[#e5e5e5] dark:border-zinc-800 shadow-2xl p-6 animate-reveal z-10 space-y-4">
        <h3 className="font-serif text-xl font-bold text-red-600 dark:text-red-500">¿Eliminar Producto?</h3>
        <p className="text-sm text-[#666666] dark:text-neutral-400 leading-relaxed">
          ¿Estás seguro de que deseas eliminar permanentemente el producto <strong className="text-[#1a1a1a] dark:text-white">"{productoNombre}"</strong>? Esta acción no se puede deshacer y afectará los registros actuales.
        </p>
